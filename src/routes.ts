...
export function RegisterRoutes(app: express.Router) {
    ...
    app.get(
        ...
        async function ExtractImageController_Extract(
            request: any,
            response: any,
            next: any
        ) {
            ...
            try {
                ...
                const controller: any =
                    await container.get<ExtractImageController>(
                ...
                const promise = controller.Extract.apply(
                    controller,
    ...
    app.get(
        ...
        async function HealthCheckController_Ready(
            request: any,
            response: any,
            next: any
        ) {
            ...
            try {
                ...
                const controller: any =
                    await container.get<HealthCheckController>(
                ...
                const promise = controller.Ready.apply(
                    controller,
                    validatedArgs as any
                )
                promiseHandler(controller, promise, response, undefined, next)
